    ...
    if (info.status === 'trial') {
      ...
      bar.innerHTML = `
        <div style="background:linear-gradient(90deg, #4C0519, #1a0008);border-bottom:2px solid #FB7185;color:#FFE4E6;padding:12px 16px;display:flex;align-items:center;justify-content:space-between;font-size:13px;">
          <div>🚫 <strong style="color:#FB7185">OUTLET REVOKED:</strong> This unit has been deactivated by the central administrator. All access is blocked. Contact MPI Billing support.</div>
          <div style="display:flex;gap:8px;align-items:center">
            <span class="badge badge-danger" style="font-size:12px;padding:4px 10px;background:#9F1239">Revoked by Admin</span>
          </div>
        </div>`;
      bar.style.display = 'block';
